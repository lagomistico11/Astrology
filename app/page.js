...
import { Star, Clock, Calendar, Mail, User, LogOut, CreditCard, Sparkles, Sun, Moon, X } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              <Card key={service.id} className={`relative bg-gradient-to-br from-purple-900/40 to-indigo-900/40 border border-yellow-500/30 backdrop-blur-sm hover:from-purple-800/50 hover:to-indigo-800/50 transition-all duration-300 ${service.popular ? 'ring-2 ring-yellow-400/60' : ''}`}>
                {service.popular && (
